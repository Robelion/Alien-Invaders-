...
WelcomeFontSize = 30
#Size of the lost message
LostFontSize = 20
#Number of colums divided by 2
HalfofColums = 6
#right border of the screen where the aliens should stop
rightborder = GAME_WIDTH - ALIEN_H_SEP - ALIEN_WIDTH
#left border of the screen where the aliens should stop
leftborder = ALIEN_H_SEP + ALIEN_WIDTH
